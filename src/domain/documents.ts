...
type DocumentService = {
  documents: {
    ...
    >;
    find(ctx: Context, params: { id: string }): ResultAsync<
      { document: Document },
      NotFoundError | InternalServerError | PermissionDeniedError | UnauthorizedError
    >;
  };
  categories: {
    findMany(ctx: Context): ResultAsync<
      { categories: DocumentCategory[], total: number },
      InternalServerError | PermissionDeniedError | UnauthorizedError
    >;
    delete(ctx: Context, params: { id: string }): ResultAsync<
