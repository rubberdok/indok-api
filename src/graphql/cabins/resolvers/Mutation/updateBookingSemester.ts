...
export const updateBookingSemester: NonNullable<MutationResolvers["updateBookingSemester"]> = async (
  _parent,
  { data },
  ctx
) => {
  ...
  const { startAt: rawStartAt, endAt: rawEndAt, semester, bookingsEnabled } = data;
