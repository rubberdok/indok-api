...
import    { DateTimeResolver } from 'graphql-scalars';
    export const resolvers: Resolvers = {
      ...
      Mutation: { addMember: Mutation_addMember,authenticate: Mutation_authenticate,createOrganization: Mutation_createOrganization,logout: Mutation_logout,newBooking: Mutation_newBooking,redirectUrl: Mutation_redirectUrl,removeMember: Mutation_removeMember,updateBookingStatus: Mutation_updateBookingStatus,updateOrganization: Mutation_updateOrganization,updateUser: Mutation_updateUser },
