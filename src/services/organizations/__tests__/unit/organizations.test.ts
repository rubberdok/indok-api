...
describe("OrganizationService", () => {
  ...
  describe("update", () => {
    describe("should raise:", () => {
      ...
      test.each(testCases)("$expectedError.name $name", async ({ state, input, expectedError }) => {
         ...
         */
        await expect(organizationService.update(input, state.user.id)).rejects.toThrow(expectedError);
      });
    });
    ...
    describe("should update the organization", () => {
      ...
      test.each(testCases)(
        ...
        async ({ state, input }) => {
           ...
           * new organization name.
           */
          const actual = organizationService.update(input, state.user.id);
          ...
          expect(organizationRepository.update).toHaveBeenCalledWith(input.organizationId, {
            name: input.name,
  ...
  describe("create", () => {
    ...
    describe("should create the organization", () => {
      ...
      test.each(testCases)("name: $input.name, description: $input.description", async ({ state, input }) => {
        /**
         * Arrange.
         *
         * Set up the mock user and hasRole implementation.
  ...
  describe("addMember", () => {
    ...
    describe("should raise:", () => {
      ...
      test.each(testCases)("$expectedError.name $name", async ({ state, input, expectedError }) => {
         ...
         */
        expect(organizationService.addMember(state.user.id, input)).rejects.toThrow(expectedError);
      });
    });
  });
  ...
  describe("removeMember", () => {
    describe("should raise:", () => {
      ...
      const testCases: TestCase[] = [
        ...
        },
        {
          ...
          state: {
            user: mock<User>({ id: "1", isSuperUser: false }),
            role: Role.ADMIN,
            members: [mock<Member>({ id: "1", userId: "1", organizationId: "1", role: Role.ADMIN })],
          },
          input: {
            organizationId: "1",
            userId: "1",
        ...
        },
        {
          ...
          state: {
            ...
            role: Role.ADMIN,
            members: [
              mock<Member>({ id: "1", userId: "1", organizationId: "1", role: Role.ADMIN }),
              mock<Member>({ id: "2", userId: "3", organizationId: "1", role: Role.MEMBER }),
            ],
          },
          input: {
            organizationId: "1",
      ...
      test.each(testCases)("$expectedError.name $name", async ({ name, state, input, expectedError }) => {
        ...
        memberRepository.get.mockImplementationOnce(getMockGetImplementation(state));
         ...
         * new member's user ID and role.
         */
        await expect(organizationService.removeMember(state.user.id, input)).rejects.toThrow(expectedError);
      });
    });
      ...
      const testCases: TestCase[] = [
        {
          ...
          state: {
            ...
            role: Role.MEMBER,
            members: [
              mock<Member>({ id: "1", userId: "1", organizationId: "1", role: Role.MEMBER }),
              mock<Member>({ id: "2", userId: "2", organizationId: "1", role: Role.ADMIN }),
            ],
          },
          input: {
            organizationId: "1",
        ...
        },
        {
          ...
          state: {
            ...
            members: [
              mock<Member>({ id: "1", userId: "1", organizationId: "1", role: Role.ADMIN }),
              mock<Member>({ id: "2", userId: "2", organizationId: "1", role: Role.MEMBER }),
            ],
          },
          input: {
            organizationId: "1",
